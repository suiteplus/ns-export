...
module.exports = function(casper, init) {
    ...
    var downloadRecord = function (opt) {
        ...
        if (recType === 'transaction') {
            $$recType = casper.evaluate(function (id) {
                var search = nlapiCreateSearch( 'transaction', ['internalid', 'is', id]),
        ...
        console.log('downloading Record: "' + recType + ($$recType ? '['+$$recType+']': '') + '" = '+ id);
